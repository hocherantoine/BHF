...
## 
## Date: January 2021
## Amended 20 june 2023 to implement iBAQ values for abundancy within nucleoid
...
data=read.delim("/Users/ahocher/Dropbox/Laboratory/Bacterial_Histones/Bacterial_histones_phylogeny/PROTEOMES/Original_data_wiBAQ/b023p057_Lepto_with_iBAQ_proteinGroups.txt",header=T,sep="\t",stringsAsFactors = F)
names(data)[1]="ID"
...
Corresp=blast_best_reciprocal_hit(Uniprot,Genbank,search_type = "protein_to_protein",task="blastp-fast",is.subject.db = T)
...
names(Correspdt)=c("UniprotID","GenbankID")
...
#Export
write.table(data2,file="/Users/ahocher/Dropbox/Laboratory/Bacterial_Histones/Bacterial_histones_phylogeny/PROTEOMES/LEPTOSPIRA/INHOUSE/Leptospira_Interrogans_MassSpec_PFAMAnno_wiBAQ.txt",sep="\t",quote=F,row.names=F)
...
#Re-load
data=read.table("/Users/ahocher/Dropbox/Laboratory/Bacterial_Histones/Bacterial_histones_phylogeny/PROTEOMES/LEPTOSPIRA/INHOUSE/Leptospira_Interrogans_MassSpec_PFAMAnno_wiBAQ.txt",header=T,sep="\t",quote="",stringsAsFactors = F)
...
#Export : 
write.table(AA,file="/Users/ahocher/Dropbox/Laboratory/Bacterial_Histones/Bacterial_histones_phylogeny/PROTEOMES/LEPTOSPIRA/INHOUSE/230620_Leptospira_Interrogans_MassSpec_Enrichment.txt",sep="\t",quote=F,row.names=F)


#Testing DNA binding protein enrichment : 
...
ggsave(plot = volcanoPlot,filename = "/Users/ahocher/Dropbox/Laboratory/Bacterial_Histones/Bacterial_histones_phylogeny/Figures/MASS_SPEC/LEPTOSPIRA/INTERROGANS/230620_Nuc_vs_Top_volcanoPlotUncorrectedpval.pdf")
...
ggsave(plot = EnrichmentPlot,filename = "/Users/ahocher/Dropbox/Laboratory/Bacterial_Histones/Bacterial_histones_phylogeny/Figures/MASS_SPEC/LEPTOSPIRA/INTERROGANS/230620_Nuc_vs_Top_enrichment_vs_WCE_Intensity_orange_candidate_blueDNAbinding.pdf")
...
pdf("/Users/ahocher/Dropbox/Laboratory/Bacterial_Histones/Bacterial_histones_phylogeny/Figures/MASS_SPEC/LEPTOSPIRA/INTERROGANS/230620_Linterrogans_PearsonCorrealtion_MS_replicates.pdf",height=6,width=6)
corrplot(CorMatRes)
dev.off()

CorMatRes=cor(CorMat,method="spearman")

pdf("/Users/ahocher/Dropbox/Laboratory/Bacterial_Histones/Bacterial_histones_phylogeny/Figures/MASS_SPEC/LEPTOSPIRA/INTERROGANS/230620_Linterrogans_SpearmanCorrealtion_MS_replicates.pdf",height=6,width=6)
corrplot(CorMatRes)
dev.off()
...
WCEPlot$iBAQ.INT_NUC.avg=(WCEPlot$iBAQ.INT_NUC_1+WCEPlot$iBAQ.INT_NUC_2+WCEPlot$iBAQ.INT_NUC_3)/3

WCEPlot$iBAQ.INT_TOP.avg=(WCEPlot$iBAQ.INT_TOP_1+WCEPlot$iBAQ.INT_TOP_2+WCEPlot$iBAQ.INT_TOP_3)/3



WCEPlot$LFQ.intensity.WCE.avg=(WCEPlot$LFQ.intensity.WCE_1+WCEPlot$LFQ.intensity.WCE_2)/2
WCEPlot$iBAQ.INT_WCE.avg=(WCEPlot$iBAQ.INT_WCE_1+WCEPlot$iBAQ.INT_WCE_2)/2
...
ggsave(addSmallLegend(LocaAndName),filename = "/Users/ahocher/Dropbox/Laboratory/Bacterial_Histones/Bacterial_histones_phylogeny/Figures/MASS_SPEC/LEPTOSPIRA/INTERROGANS/230620_Nuc_vs_Top_enrichment_scatter_log2scale.pdf")
...
ggsave(addSmallLegend(LocaAndName),filename = "/Users/ahocher/Dropbox/Laboratory/Bacterial_Histones/Bacterial_histones_phylogeny/Figures/MASS_SPEC/LEPTOSPIRA/INTERROGANS/230620_Nuc_vs_Top_enrichment_scatter_linearscale.pdf")
...
ggsave(addSmallLegend(DNABindingFocus),filename = "/Users/ahocher/Dropbox/Laboratory/Bacterial_Histones/Bacterial_histones_phylogeny/Figures/MASS_SPEC/LEPTOSPIRA/INTERROGANS/230620_Nuc_vs_Top_enrichment_DNA_bindingFocus_scatter_log2scale.pdf")
...
DNABindingFocus=ggplot(data=WCEPlot)+geom_point(aes(y=NUC_vs_TOP_ratio,x=LFQ.intensity.Nuc_avg,color=as.factor(PFAM_DNA_binding.x)),size=0.5)+geom_text_repel(data=WCEPlot[which(WCEPlot$PFAM_DNA_binding.x==1 & WCEPlot$NUC_vs_TOP_ratio>1 & WCEPlot$PadjBH <0.01)[1:20],],aes(y=NUC_vs_TOP_ratio,x=LFQ.intensity.Nuc_avg,label=ID.x),color="black",size=1,min.segment.length = 0.1)+theme_pubclean()+theme(aspect.ratio=1/1.61,legend.position = "top")+scale_color_manual(values=c("grey80","blue"))+xlab("Intensity, nucleoid fraction")+ylab("Enrichment \nNucleoid vs Top fraction")+scale_x_sqrt()
ggsave(addSmallLegend(DNABindingFocus),filename = "/Users/ahocher/Dropbox/Laboratory/Bacterial_Histones/Bacterial_histones_phylogeny/Figures/MASS_SPEC/LEPTOSPIRA/INTERROGANS/230620_Nuc_vs_Top_enrichment_DNA_bindingFocus_scatter_.pdf")
...
ggsave(addSmallLegend(DNABindingFocus),filename = "/Users/ahocher/Dropbox/Laboratory/Bacterial_Histones/Bacterial_histones_phylogeny/Figures/MASS_SPEC/LEPTOSPIRA/INTERROGANS/230620_Nuc_vs_Top_enrichment_DNA_bindingFocus_scatter_with_description.pdf")
...
ggsave(addSmallLegend(DNABindingFocus),filename = "/Users/ahocher/Dropbox/Laboratory/Bacterial_Histones/Bacterial_histones_phylogeny/Figures/MASS_SPEC/LEPTOSPIRA/INTERROGANS/230620_Nuc_vs_Top_enrichment_DNA_bindingFocus_scatter_with_description_xlabWCEIntensity.pdf")
...
ggsave(LocalisationPlot,filename = "/Users/ahocher/Dropbox/Laboratory/Bacterial_Histones/Bacterial_histones_phylogeny/Figures/MASS_SPEC/LEPTOSPIRA/INTERROGANS/230620_Nuc_vs_Top_enrichment_stratified_by_localisation.pdf")
...
#Focus on Scc : 
DNABindingFocus=ggplot(data=WCEPlot)+geom_point(aes(y=NUC_vs_TOP_ratio,x=LFQ.intensity.Nuc_avg),size=0.5)+geom_point(data=WCEPlot[which(WCEPlot$ID.x=="A0A2H1XHS2"),],aes(y=NUC_vs_TOP_ratio,x=LFQ.intensity.Nuc_avg),size=1,color="red")+geom_point(data=WCEPlot[which(WCEPlot$ID.x=="A0A2H1XGH2"),],aes(y=NUC_vs_TOP_ratio,x=LFQ.intensity.Nuc_avg),size=1,color="orange")+geom_point(data=WCEPlot[which(WCEPlot$ID.x=="A0A2H1XG06"),],aes(y=NUC_vs_TOP_ratio,x=LFQ.intensity.Nuc_avg),size=1,color="green")+geom_text_repel(data=WCEPlot[which(WCEPlot$ID.x%in%c("A0A2H1XHS2","A0A2H1XGH2","A0A2H1XG06")),],aes(y=NUC_vs_TOP_ratio,x=LFQ.intensity.Nuc_avg,label=Description),color="black",size=3,min.segment.length = 0.1,max.overlaps=1000)+theme_pubr()+theme(aspect.ratio=1/1.61,legend.position = "top")+scale_color_manual(values=c("grey80","blue"))+xlab("Intensity, nucleoid fraction")+ylab("Enrichment \nNucleoid vs Top fraction")+scale_x_sqrt()
ggsave(addSmallLegend(DNABindingFocus),filename = "/Users/ahocher/Dropbox/Laboratory/Bacterial_Histones/Bacterial_histones_phylogeny/Figures/MASS_SPEC/LEPTOSPIRA/INTERROGANS/230620_Nuc_vs_Top_enrichment_scatter_with_HFOrange_H1Green_SccRed.pdf",height = 12,width=12)
...
iBAQ_columns <- grep("iBAQ", colnames(WCEPlot)) # get LFQ column numbers
WCEPlot.e=WCEPlot[,c(which(names(WCEPlot)%in%c(names(AA),"Final_Localization","Protein.Name","Signal_Details","PFAM_DNA_binding.y","NAP")),LFQ_columns,iBAQ_columns)]

#Export Table with all data : 
write.table(WCEPlot.e,"/Users/ahocher/Dropbox/Laboratory/Bacterial_Histones/Bacterial_histones_phylogeny/PROTEOMES/LEPTOSPIRA/INHOUSE/b023p057_Leptospira_Interrogans_MassSpec_Enrichment_w_localisation_230620_wiBAQ.txt",sep="\t",row.names=F,quote=F)
